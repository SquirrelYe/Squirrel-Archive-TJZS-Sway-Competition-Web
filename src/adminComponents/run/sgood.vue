        ...
        <div class="panel panel-default">
          ...
          <div class="form-group row">
            <form class="form-horizontal" role="form">
              <div class="col-md-2">
                <div class="col-md-4 control-label" style="font-weight: 900">
                  <strong>公司名称</strong>
                </div>
                <div class="col-md-8">
                  <select
            ...
            <ul class="nav nav-tabs navtab-bg">
              <li class="active">
                <a href="#me" data-toggle="tab" aria-expanded="true">
                  ...
                  <span class="hidden-xs" @click="getGoodByCompany_id()"
                    >自研产品</span
                  >
                </a>
              </li>
                ...
                <div class="table-responsive">
                  ...
                  >
                    ...
                    <tbody>
                      <tr
                        class="gradeX"
                        v-for="(item, index) in showOEM"
                        :key="index"
                        v-if="item.commerresearch"
                      >
                        <td>{{ item.id }}</td>
                        ...
                        <td>
                          {{ item.commerresearch.condition | formatCondition }}
                        </td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" align="center">
            <div class="row">
              <div class="col-sm-12">
                <div class="panel panel-default">
                  <div class="panel-heading" v-if="currentGoodItem">
                    <h4>{{ currentGoodItem.name }}授权信息</h4>
                  </div>
                  <div class="panel-body">
                    <div class="table-responsive">
                      <table
                          ...
                          >
                            ...
                            <td>
                              <a
                                ...
                                @click="deleteOemCompanyItem(item)"
                                data-dismiss="modal"
                              >
                                <i
                                  class="fa fa-trash-o"
    ...
    deleteOemCompanyItem(item) {
      req
        ...
        .then((res) => {
          ...
          swal(
            "撤销产品授权公司信息成功!",
            `${item.other_2.name}不再开始代工生产${item.commerresearch.name}产品`,
            "success"
          );
        });
    },
