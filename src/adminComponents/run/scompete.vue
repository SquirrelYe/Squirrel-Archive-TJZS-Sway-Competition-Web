            ...
            <div class="col-lg-12">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="home">
                      ...
                      >
                        ...
                        <tbody>
                          <tr
                            ...
                            :key="index"
                            :class="{
                              important: item.condition == 3,
                              bold: item.condition == -3,
                            }"
                          >
                            <td>{{ index }}</td>
                            <td>M{{ item.id }}</td>
                  ...
                  <p>
                    <strong
                      >注意：拍卖过程分为明拍与暗拍两种，暗拍点击竞价排名选择最高者发送，明拍根据线下竞拍场景点击定向公司发送，输入竞拍价后发送。以上价钱单位均为万元</strong
                    >。
                  </p>
                </div>
                <!-- 工业用地展示处 -->
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div
                        class="m-b-30"
                        data-toggle="modal"
                        data-target="#commerland"
                      >
                        <button
                          id="addToTable"
                          class="btn btn-primary waves-effect waves-light"
                        >
                          发布商业用地竞拍<i class="fa fa-plus"></i>
                        </button>
                      </div>
                    </div>
                  </div>
