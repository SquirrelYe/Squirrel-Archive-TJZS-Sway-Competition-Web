    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          ...
          <h4 class="page-title" style="color: red" v-if="showStasticsItem">
            当前所在公司
            {{
              showStasticsItem.company.name
            }}!&nbsp;&nbsp;&nbsp;&nbsp;当前财年：{{ gameinfo.Yearid }}
          </h4>
          ...
          <div class="panel panel-border panel-primary widget-s-1">
            ...
            <div class="panel-body">
              <div class="h2 text-primary">
                {{
                  Number(showStasticsItem.float) +
                  Number(showStasticsItem.fixed)
                }}
              </div>
      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="portlet">
            <div class="portlet-heading">
              <h3 class="portlet-title text-dark text-uppercase">赛事数据</h3>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div
                      ...
                      class="flot-chart line1"
                      style="height: 320px; padding: 0px; position: relative"
                    ></div>
                  </div>
                </div>
              </div>
        ...
        <div class="col-lg-4">
          <div class="portlet">
            <div class="portlet-heading">
              <h3 class="portlet-title text-dark text-uppercase">赛事统计</h3>
              <div class="clearfix"></div>
            </div>
