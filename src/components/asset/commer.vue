              ...
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="row">
                    <div
                      class="col-lg-4"
                      v-for="(item, index) in showCompeteCommerland"
                      :key="index"
                    >
                      <div
                      ...
                      >
                        <div class="panel-heading" style="height: 40px">
                          ...
                          <i
                            ...
                            v-if="showCompeteCommerland[index].research == null"
                            >配置研究所
                          </i>
                        </div>
                        <div class="panel-body">
                          ...
                          <div class="row" v-else>
                            <div style="color: white">研究所信息如下：</div>
                            <br />
                            <div class="col-lg-12">
                              <div class="btn-group">
                                <button
                                  ...
                                  aria-expanded="false"
                                  :class="{
                                    'btn-default': index % 4 == 0,
                                    'btn-success': index % 4 == 1,
                                    'btn-warning': index % 4 == 2,
                                    'btn-primary': index % 4 == 3,
                                  }"
                                >
                                  {{
        ...
        <div class="modal-content p-0">
          <div class="panel-group panel-group-joined" id="accordion-test">
            <div
              ...
              v-for="(item, index) in judgeShowResearch"
              :key="index"
            >
              <div class="panel-heading">
              ...
              >
                <div class="modal-body" align="center">
                  ...
                  <strong>订单总额为:</strong
                  ><strong style="color: green">{{ item.price }}万元</strong
                  ><br />
                </div>
                ...
                <div class="modal-footer">
                  ...
                  <button
                    ...
                    data-dismiss="modal"
                    @click="sendPrice(item, item.price, item.id)"
                  >
                    提交订单
                  </button>
                </div>
    ...
    sendPrice(item, money, research_id) {
      ...
      apis.getOneStatisticByCompanyId(that.company_id).then((res) => {
        if (res.data.float >= money) {
          ...
          req
            .post(
              `api/statistic?judge=4&float=${float}&fixed=${fixed}&brand=${brand}&company_id=${that.company_id}`
            )
            .then((res) => {});
          // 绑定研究所
          req
            ...
            .then((res) => {
              ...
              // 写入交易
              req.post(
                `api/transaction?judge=1&id=0&Yearid=${that.Yearid}&inout=1&type=4&kind=3&price=${money}&number=1&me=${that.company_id}&research_id=${research_id}`
              );
            });
        } else {
