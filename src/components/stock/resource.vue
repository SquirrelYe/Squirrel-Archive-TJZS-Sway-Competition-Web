        ...
        <div class="modal-content">
            ...
            <div class="modal-content p-0">
              ...
              <div class="tab-content">
                <div
                  ...
                  id="profile-2"
                  v-if="currentChooseditem"
                >
                  <address class="ng-scope" align="center">
                    <strong>原料名称:</strong>{{ currentChooseditem.source.name
                    }}<br />
          ...
          <div class="modal-footer">
            ...
            <button
              ...
              data-dismiss="modal"
              @click="toPublic(currentChooseditem)"
              v-if="currentChooseditem.sum > 0"
            >
              原料上架
            </button>
          </div>
          ...
          <div class="modal-body" align="center">
            ...
            <div class="modal-footer">
              ...
              <button
                ...
                class="btn btn-primary waves-effect waves-light"
                data-dismiss="modal"
                @click="sendResourceToCompany()"
                v-if="
                  number > 0 &&
                  number <= sendResourceItem.sum &&
                  toCompany != company_id
                "
              >
                定向发送原料
              </button>
...
export default {
  ...
  methods: {
      ...
      async.series(
        [
          ...
          (callback) => {
            ...
            that.getCompanyResourceStock(
              that.sendResourceItem,
              that.toCompany,
              callback
            );
          },
    ...
    updateResourceStock(results, number) {
      ...
      // 写入交易
      req.post(
        `api/transaction?judge=1&id=0&Yearid=${this.Yearid}&inout=1&type=1&kind=1&price=0&number=${number}&me=${this.company_id}&other=${results[0][0].company_id}&source_id=${results[0][0].source_id}`
      );
      this.init();
