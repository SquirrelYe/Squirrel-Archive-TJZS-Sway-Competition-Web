      ...
      <div class="col-sm-12">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title">Sway商战大赛-新建公司</h3>
          </div>
          <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input
                    disabled
                    class="form-control"
                    placeholder="51370113MJD7670793"
                    v-model="code"
                  />
                </div>
              </div>
            ...
            <div class="col-md-11">
              注意：<br />
              <strong
                >公司由选出的公司CEO创建，公司创建完成之后，公司其他成员通过
                公司->加入公司 找到并加入公司。</strong
              ><br />
              <strong
                >比赛准备中可以创建公司，比赛正式开始后无法创建公司。</strong
              >
            </div>
          </div>
        </div>
  ...
  methods: {
    submitForm() {
      if (
        ...
        if (JSON.parse(ses.getSes("gameinfo")).condition != 0)
          s_alert.Success(
            "未在准备中不能创建公司",
            "公司创建在比赛准备中进行",
            "warning"
    ...
    enterCompany(cid, callback) {
      //加入公司
      req
        .get_Param("/api/ass/company_sway", {
          judge: 0,
    ...
    updateUserInfoSession(uid, callback) {
      apis.getOneSwayById(uid).then((res) => {
