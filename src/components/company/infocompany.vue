  ...
  methods: {
    ...
    getPartner() {
      req
        ...
        .then((res) => {
          print.log("获取公司 成员信息", res.data);
          this.showItems = res.data;
          if (res.data.length !== 0) this.judgeShow = true;
        });
    },
    //修改职位
    modified(uid) {
    ...
    showMe() {
      ...
      print.log("显示自己公司信息", this.meinfo);
    },
    editItem(item) {
      this.model = item;
    },
