    ...
    n = (function () {
      var b = function (b) {
        ...
        e = function (b) {
          ...
          return (
            (e = c.is(".note-editor, .note-air-editor")
              ? c
              : a("#note-editor-" + k.last(c.attr("id").split("-")))),
            d(e)
          );
        },
        f = function (a) {
        ...
        G = function (a) {
          ...
          return 0 === b
            ? !0
            : g(a) || 1 !== b || a.innerHTML !== E
            ? k.all(a.childNodes, g) && "" === a.innerHTML
              ? !0
              : !1
            : !0;
        },
        ...
        aa = function (a, c) {
          ...
          if (0 === a.offset) {
            ...
            _(a.node)
              ? ((d = a.node.childNodes[a.offset - 1]), (e = F(d)))
        ...
        ba = function (a, c) {
          ...
          if (F(a.node) === a.offset) {
            ...
            _(a.node)
              ...
              : ((d = a.node), (e = c ? F(a.node) : a.offset + 1));
          return { node: d, offset: e };
        },
        ca = function (a, b) {
          ...
          return d.length
            ? 1 === d.length
              ...
              : d.reduce(function (a, d) {
                  return (
                    a === b.node && (a = ka(b, c)),
                    ka({ node: d, offset: a ? n.position(a) : F(d) }, c)
                  );
                })
            : null;
        },
        ma = function (a, b) {
          ...
          var h =
            c &&
            la(c, a, { isSkipPaddingBlankHTML: b, isNotSplitEdgePoint: b });
          return (
            h || d !== a.node || (h = a.node.childNodes[a.offset]),
            { rightNode: h, container: d }
          );
        },
        na = function (a) {
    ...
    o = (function () {
      var b = function (a, b) {
          ...
          if (0 !== c && n.isText(g[c - 1])) {
            ...
            for (
              var l = j.text.replace(/[\r\n]/g, "").length;
              l > i.nodeValue.length && i.nextSibling;
            ...
            b &&
              i.nextSibling &&
              n.isText(i.nextSibling) &&
              l === i.nodeValue.length &&
              ((l -= i.nodeValue.length), (i = i.nextSibling)),
              (e = i),
              (c = l);
          }
        ...
        d = function (b, e, f, g) {
          ...
          (this.getPoints = function () {
            ...
            (this.normalize = function () {
              var a = function (a, b) {
                  if (
                    (n.isVisiblePoint(a) && !n.isEdgePoint(a)) ||
                    (n.isVisiblePoint(a) && n.isRightEdgePoint(a) && !b) ||
                    (n.isVisiblePoint(a) && n.isLeftEdgePoint(a) && b) ||
                    (n.isVisiblePoint(a) &&
                      n.isBlock(a.node) &&
                      n.isEmpty(a.node))
                  )
                  ...
                  if (
                    ((n.isLeftEdgePointOf(a, c) ||
                      n.isVoid(n.prevPoint(a).node)) &&
                      !b) ||
                    ((n.isRightEdgePointOf(a, c) ||
                      n.isVoid(n.nextPoint(a).node)) &&
                      b)
                  ) {
                  ...
                  var d = b
                    ? n.nextPointUntil(n.nextPoint(a), n.isVisiblePoint)
                    : n.prevPointUntil(n.prevPoint(a), n.isVisiblePoint);
                  return d || a;
                },
                ...
                n.walkPoint(
                  ...
                  function (b) {
                    if (!n.isEditable(b.node)) {
                      var e;
                      d
                        ? (n.isLeftEdgePoint(b) && h.push(b.node),
                          n.isRightEdgePoint(b) &&
                            k.contains(h, b.node) &&
                            (e = b.node))
                        : (e = c ? n.ancestor(b.node, a) : b.node),
                        e && a(e) && g.push(e);
                    }
                  },
                  !0
            ...
            (this.splitText = function () {
              ...
              return (
                n.isText(f) &&
                  !n.isEdgePoint(this.getEndPoint()) &&
                  f.splitText(g),
                n.isText(b) &&
                  !n.isEdgePoint(this.getStartPoint()) &&
                  ((c.sc = b.splitText(e)),
                  (c.so = 0),
            ...
            (this.deleteContents = function () {
              ...
              return (
                a.each(c, function (a, b) {
                  var c = b.parentNode;
                  e.node !== c && 1 === n.nodeLength(c) && f.push(c),
                    n.remove(b, !1);
                }),
          ...
          (this.isOnEditable = l(n.isEditable)),
            (this.isOnList = l(n.isList)),
            (this.isOnAnchor = l(n.isAnchor)),
            (this.isOnCell = l(n.isCell)),
            ...
            (this.wrapBodyInlineWithPara = function () {
              ...
              if (
                ((f = f.concat(n.listNext(c.nextSibling, n.isParaInline))),
                f.length)
              ) {
            ...
            (this.getWordRange = function (a) {
              ...
              return (
                a &&
                  (b = n.nextPointUntil(b, function (a) {
                    return !n.isCharPoint(a);
                  })),
      ...
      return {
        create: function (a, c, e, f) {
          if (arguments.length) 2 === arguments.length && ((e = a), (f = c));
            ...
            n.isText(m.node) &&
              n.isLeftEdgePoint(m) &&
              n.isTextNode(o.node) &&
              n.isRightEdgePoint(o) &&
              o.node.nextSibling === m.node &&
              (m = o),
              (a = m.cont),
              (c = m.offset),
              (e = o.cont),
        ...
        createFromNode: function (a) {
          var b = a,
            ...
            e = n.nodeLength(d);
          return (
            n.isVoid(b) && ((c = n.listPrev(b).length - 1), (b = b.parentNode)),
            n.isBR(d)
              ? ((e = n.listPrev(d).length - 1), (d = d.parentNode))
              : n.isVoid(d) && ((e = n.listPrev(d).length), (d = d.parentNode)),
            this.create(b, c, d, e)
          );
        },
      ...
      var b = [],
        ...
        f = function (b) {
          null !== b.contents && a.html(b.contents),
            null !== b.bookmark && o.createFromBookmark(d, b.bookmark).select();
        };
      (this.undo = function () {
      ...
      (this.fromNode = function (a) {
        ...
        (this.styleNodes = function (b, c) {
          ...
          var g = n.makePredByNodeName(d),
            h = b.nodes(n.isText, { fullyContains: !0 }).map(function (a) {
        ...
        (this.current = function (b) {
          var c = a(n.isText(b.sc) ? b.sc.parentNode : b.sc),
            d = this.fromNode(c);
          if (
            ((d["font-bold"] = document.queryCommandState("bold")
              ? "bold"
              : "normal"),
            (d["font-italic"] = document.queryCommandState("italic")
              ? "italic"
              : "normal"),
            (d["font-underline"] = document.queryCommandState("underline")
              ? "underline"
              : "normal"),
            (d["font-strikethrough"] = document.queryCommandState(
              "strikeThrough"
            )
              ? "strikethrough"
              : "normal"),
            (d["font-superscript"] = document.queryCommandState("superscript")
              ? "superscript"
              : "normal"),
            (d["font-subscript"] = document.queryCommandState("subscript")
              ? "subscript"
              : "normal"),
            b.isOnList())
          ) {
          ...
          return (
            (d.anchor = b.isOnAnchor() && n.ancestor(b.sc, n.isAnchor)),
            (d.ancestors = n.listAncestor(b.sc, n.isEditable)),
            (d.range = b),
            d
          );
        });
      ...
      (this.insertOrderedList = function () {
        ...
        (this.indent = function () {
          var b = this,
            ...
            d = c.nodes(n.isPara, { includeAncestor: !0 }),
        ...
        (this.toggleList = function (b) {
          var c = this,
            ...
            e = d.nodes(n.isPara, { includeAncestor: !0 }),
            f = d.paraBookmark(e),
          ...
          if (k.find(e, n.isPurePara)) {
            ...
            var i = d
              .nodes(n.isList, { includeAncestor: !0 })
              .filter(function (c) {
        ...
        (this.wrapList = function (a, b) {
          ...
          return (
            ...
            n.appendChildNodes(g, a),
            f && (n.appendChildNodes(g, k.from(f.childNodes)), n.remove(f)),
            a
          );
        }),
              ...
              var f = k.head(e),
                ...
                i =
                  h.childNodes.length > 1
                    ? n.splitTree(
                        h,
                        { node: g.parentNode, offset: n.position(g) + 1 },
                        { isSkipPaddingBlankHTML: !0 }
                      )
                    : null,
                j = n.splitTree(
                  h,
                  { node: f.parentNode, offset: n.position(f) },
                  { isSkipPaddingBlankHTML: !0 }
                );
              (e = c
                ? n.listDescendant(j, n.isLi)
                : k.from(j.childNodes).filter(n.isLi)),
                (c || !n.isList(h.parentNode)) &&
                  (e = e.map(function (a) {
    ...
    y = function (b) {
      ...
      (this.createRange = function (a) {
        ...
        (this.saveRange = function (a, b) {
          this.focus(a),
            a.data("range", o.create()),
            b && o.create().collapse().select();
        }),
      ...
      (this.tab = function (a, b) {
        ...
        c.isCollapsed() && c.isOnCell()
          ? e.tab(c)
          : (l(a), f.insertTab(a, c, b.tabsize), m(a));
      }),
          ...
          q.createImage(c, d)
            .then(function (b) {
              l(a),
                ...
                o.create().insertNode(b[0]),
                o.createFromNodeAfter(b[0]).select(),
                m(a);
            })
            .fail(function () {
              var c = n.makeLayoutInfo(a).holder();
        ...
        (this.insertNode = function (a, b) {
          l(a),
            o.create().insertNode(b),
            o.createFromNodeAfter(b).select(),
            m(a);
        }),
      ...
      (this.fontSize = function (b, c) {
        ...
        if (e.isCollapsed()) {
          var f = d.styleNodes(e),
            g = k.head(f);
          a(f).css({ "font-size": c + "px" }),
            g &&
              !n.nodeLength(g) &&
              ((g.innerHTML = n.ZERO_WIDTH_NBSP_CHAR),
              o.createFromNodeAfter(g.firstChild).select(),
              b.data(x, g));
        ...
        (this.insertHorizontalRule = function (b) {
          ...
          d.nextSibling && o.create(d.nextSibling, 0).normalize().select(),
            m(b);
        }),
        (this.removeBogus = function (a) {
          ...
          if (b) {
            var c = k.find(k.from(b.childNodes), n.isText),
              d = c.nodeValue.indexOf(n.ZERO_WIDTH_NBSP_CHAR);
            -1 !== d && c.deleteData(d, 1),
              n.isEmpty(b) && n.remove(b),
              a.removeData(x);
          }
        }),
        ...
        (this.createLink = function (b, c, e) {
          var f = c.url,
            ...
            j = i.toString() !== g;
          (e = e || n.makeLayoutInfo(b).editor().data("options")),
            l(b),
          ...
          a.each(p, function (b, c) {
            a(c).attr("href", f),
              h ? a(c).attr("target", "_blank") : a(c).removeAttr("target");
          });
        ...
        (this.focus = function (a) {
          a.focus(),
            i.isFF &&
              !o.create().isOnEditable() &&
              o.createFromNode(a[0]).normalize().collapse().select();
        }),
    ...
    z = function () {
      (this.update = function (b, c) {
        ...
        if (c.image) {
          ...
          var h = f.attr("style");
          return (
            e('button[data-event="resize"][data-value="1"]', function () {
          ...
          if (n.isControlSizing(d.target)) {
            ...
            c
              .on("mousemove", function (a) {
                b.invoke(
                  "editor.resizeTo",
                  { x: a.clientX - l.left, y: a.clientY - (l.top - m) },
                  k,
                  !a.shiftKey
                ),
                  b.invoke("handle.update", f, { image: j }, o),
                  b.invoke("popover.update", g, { image: j }, o);
              })
              .one("mouseup", function () {
  ...
  var G = function (a) {
      (this.sync = function (b) {
        ...
        (this.activate = function (b) {
          var c = b.editor(),
            ...
            k = c.data("options");
          if (
            (f.val(n.html(e, k.prettifyHtml)),
            f.height(e.height()),
            a.invoke("toolbar.updateCodeview", d, !0),
            a.invoke("popover.hide", g),
            a.invoke("handle.hide", j),
            c.addClass("codeview"),
            f.focus(),
            i.hasCodeMirror)
          ) {
            ...
            if (k.codemirror.tern) {
              ...
              (l.ternServer = m),
                l.on("cursorActivity", function (a) {
                  m.updateArgHints(a);
                });
            }
        ...
        (this.deactivate = function (b) {
          ...
          f.html(k),
            ...
            l &&
              a.bindCustomEvent(c, f.data("callbacks"), "change")(f.html(), f),
            f.focus(),
                ...
                if (d && d.files && d.files.length)
                  ...
                  for (
                    ...
                    i.toLowerCase().indexOf("text") > -1
                      ? e.holder().summernote("pasteHTML", j)
                      : a(j).each(f);
                  }
              })
              .on("dragover", !1);
    ...
    I = function (b) {
      ...
      this.attach = function (f) {
        (i.isMSIE && i.browserVersion > 10) || i.isFF
          ? ((c = a("<div />")
      ...
      var d = function (d) {
        ...
        e = function (a) {
          ...
          if (c && c.items && c.items.length) {
            ...
            "file" === f.kind &&
              -1 !== f.type.indexOf("image/") &&
              b.insertImages(d, [f.getAsFile()]),
          ...
          .Deferred(function (a) {
            ...
            b.one("shown.bs.modal", function () {
              g.val(f.text),
                ...
                f.url || ((f.url = f.text || "http://"), c(i, f.text)),
                h
                  .on("input", function () {
    ...
    M = function () {
      ...
      this.insertImages = function (b, e) {
        var f = b.editor(),
          ...
          j = f.data("options");
        i.onImageUpload
          ? d(h, i, "image.upload")(e)
          : a.each(e, function (a, b) {
              var e = b.name;
              j.maximumImageFileSize && j.maximumImageFileSize < b.size
                ? d(
                    h,
                    i,
                    "image.upload.error"
      ...
      this.updateStyleInfo = function (a, b) {
        if (a) {
          ...
          d || c.toolbar.update(b.toolbar(), a),
            c.popover.update(b.popover(), a, d),
            c.handle.update(b.handle(), a, d);
        }
      };
      var h = function (a) {
          var d = a.target;
        ...
        o = function (b) {
          ...
          if (d.length) {
            ...
            if (
              -1 !==
              a.inArray(g, ["resize", "floatMe", "removeMedia", "imageShape"])
            ) {
              var m = l.handle().find(".note-control-selection");
              f = a(m.data("target"));
            }
            if (
              (j && d.parents(".popover").hide(),
              a.isFunction(a.summernote.pluginEvents[g]))
            )
      ...
      (this.bindKeyMap = function (b, d) {
        ...
        g.on("keydown", function (h) {
          ...
          if (m) {
            if (
              ((k = a.summernote.pluginEvents[l]),
              a.isFunction(k) && k(h, c.editor, b))
            )
              return !1;
            (k = a.summernote.pluginEvents[m]),
              a.isFunction(k)
                ? k(h, c.editor, b)
                : c.editor[m]
                ? (c.editor[m](g, f.data("options")), h.preventDefault())
                : e[m] && (e[m].call(this, b), h.preventDefault());
          } else r.isEdit(h.keyCode) && c.editor.afterCommand(g);
        });
      }),
        (this.attach = function (a, b) {
          b.shortcuts && this.bindKeyMap(a, b.keyMap[i.isMac ? "mac" : "pc"]),
            a.editable().on("mousedown", f),
            a.editable().on("keyup mouseup", g),
            a.editable().on("scroll", l),
            c.clipboard.attach(a, b),
            c.handle.attach(a, b),
            a.popover().on("click", o),
            a.popover().on("mousedown", m),
            c.dragAndDrop.attach(a, b),
            b.airMode ||
              (a.toolbar().on("click", o),
              a.toolbar().on("mousedown", m),
              c.statusbar.attach(a, b));
        ...
        (this.attachCustomEvent = function (b, c) {
          ...
          f.focus(d(e, g, "focus")),
            ...
            f.keydown(function (a) {
              a.keyCode === r.code.ENTER && d(e, g, "enter").call(this, a),
                d(e, g, "keydown").call(this, a);
            }),
            f.keyup(d(e, g, "keyup")),
            f.on("mousedown", d(e, g, "mousedown")),
            f.on("mouseup", d(e, g, "mouseup")),
            f.on("scroll", d(e, g, "scroll")),
            f.on("paste", d(e, g, "paste"));
          var h = i.isMSIE
          ...
          f.on(h, function () {
            ...
            c.airMode ||
              (b.toolbar().click(d(e, g, "toolbar.click")),
              b.popover().click(d(e, g, "popover.click"))),
            n.isTextarea(k.head(e)) &&
              e.closest("form").submit(function (a) {
                b.holder().val(b.holder().code()),
                  d(e, g, "submit").call(this, a, e.code());
              }),
            n.isTextarea(k.head(e)) &&
              c.textareaAutoSync &&
              e.on("summernote.change", function () {
                b.holder().val(b.holder().code());
              }),
            d(e, g, "init")(b);
          for (var j = 0, l = a.summernote.plugins.length; l > j; j++)
            a.isFunction(a.summernote.plugins[j].init) &&
              a.summernote.plugins[j].init(b);
        }),
    ...
    N = function () {
      var b = function (a, b) {
          ...
          fontname: function (a, c) {
            var d = [],
              e = c.fontNames.reduce(function (a, b) {
                return i.isFontInstalled(b) ||
                  k.contains(c.fontNamesIgnoreCheck, b)
                  ? (d.push(b),
                    a +
        ...
        h = function (e, f) {
          var h = function () {
            ...
            j = function () {
              for (
                var b = a("<div />"), c = 0, h = f.airPopover.length;
                h > c;
                c++
              ) {
                for (
        ...
        t = function (a, b) {
          ...
          return (
            b.extraKeys && d.push("<div " + c + ">" + s(a, b) + "</div>"),
        ...
        y = function (a) {
          return (
            i.isMac && (a = a.replace("CMD", "⌘").replace("SHIFT", "⇧")),
            a
              .replace("BACKSLASH", "\\")
              .replace("SLASH", "/")
              .replace("LEFTBRACKET", "[")
      ...
      (this.createLayoutByAirMode = function (b, c) {
        ...
        b.addClass("note-air-editor note-editable panel-body"),
          b.attr({ id: "note-editor-" + f, contentEditable: !0 });
        var g = document.body,
          k = a(h(d, c));
        k.addClass("note-air-layout"),
          k.attr("id", "note-popover-" + f),
          k.appendTo(g),
          z(k, e),
          A(k, c);
        var m = a(l(c));
        m.addClass("note-air-layout"),
          m.attr("id", "note-handle-" + f),
          m.appendTo(g);
        var n = a(w(d, c));
        n.addClass("note-air-layout"),
          n.attr("id", "note-dialog-" + f),
        ...
        (this.createLayoutByFrame = function (b, c) {
          ...
          c.height && k.height(c.height),
            c.direction && k.attr("dir", c.direction);
          var m = b.attr("placeholder") || c.placeholder;
          m && k.attr("data-placeholder", m),
            k.html(n.html(b) || n.emptyPara),
            a('<textarea class="note-codable"></textarea>').prependTo(f);
          var o = a(h(d, c)).prependTo(f);
          A(o, c), z(o, D), a(l(c)).prependTo(f), f.prependTo(e);
          for (
            var p = a('<div class="note-toolbar panel-heading" />'),
              q = 0,
              r = c.toolbar.length;
            r > q;
            q++
            ...
            for (
              var s = c.toolbar[q][0],
                t = c.toolbar[q][1],
                u = a('<div class="note-' + s + ' btn-group" />'),
                v = 0,
                y = t.length;
              y > v;
              v++
      ...
      summernote: function () {
        ...
        if (
          ...
          for (var f = 0, g = a.summernote.plugins.length; g > f; f++) {
            ...
            e.plugin[h.name] &&
              (a.summernote.plugins[f] = a.extend(!0, h, e.plugin[h.name]));
          }
